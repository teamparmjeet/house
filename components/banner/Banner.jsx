            ...
            <div className="rounded-xl bg-indigo-600/50 p-4 backdrop-blur-md">
              ...
              <div className=" rounded-full mt-3 overflow-hidden bg-white grid grid-cols-6 ">
                ...
                <div className="col-span-1 flex items-center p-1 md:px-2 justify-center">
                  <button className="p-2 bg-green-500 w-full mx-auto rounded-full text-white transition duration-300 hover:bg-green-600">
                    <span className="md:hidden flex justify-center"><Search color="white" width={20} /></span>
