        ...
        <>
            <div className=' bg-white p-6  rounded-md shadow border'>
                ...
                <div className="flex flex-col  gap-3">
                    <div >
                        <Image alt='' width={200} height={100} src="/image/Black_Outline_Street_Brand_Modern_Typography_Logo__1___1_-removebg-preview.png" />
                    </div>
                    <div>
                        <h2 className="text-xl font-semibold text-gray-800">Ghar Dekho</h2>
