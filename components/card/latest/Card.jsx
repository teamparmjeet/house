    ...
    return (
        <>
            ...
            <div className=" relative rounded-md overflow-hidden">
                <Image alt='' className=' object-cover h-full  w-full' src="/image/anant_emerald-bapu_nagar_jaipur-jaipur-anant_group.avif" width={400} height={151} />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-transparent to-black"></div>

                <div className=' p-2 absolute bottom-0 left-0 right-0 text-white'>
