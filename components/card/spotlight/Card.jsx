                ...
                <Link href={`/page/singlepage/id`}>
                    <div className="rounded-2xl border-2 group overflow-hidden mx-2 bg-white grid lg:grid-cols-7">
                        ...
                        <div className="lg:col-span-5 relative  lg:h-96 h-52 order-1 lg:order-2">
                            <Image alt='' className='object-cover absolute opacity-0 group-hover:opacity-100 duration-300 lg:h-96 h-52  w-full' src="/image/property-grid-3.png" width={982} height={880} />
