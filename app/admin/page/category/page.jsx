...
import Categorypoupup from "../../components/category/Poupup"
...
export default function Category() {
    ...
    const fetchServices = async () => {
        setIsLoading(true);
        try {
            const response = await axios.get('/api/category/fetchall/category');
    ...
    return  (
        <div>
            <AddCategory onServiceAdded={fetchServices} />
            <ToastContainer />
            ...
            {isLoading ? (
                ...
                <div>
                    ...
                    {currentServices.map((service, index) => (
                        ...
                        >
                            <div className="lg:col-span-1 bg-2 rounded-md px-2 text-white flex items-center">{service.name}</div>
                            <div className="lg:col-span-4 rounded-md px-2 text-gray-800 line-clamp-1 leading-9">{service.details}</div>
                        </div>
                    ))}
